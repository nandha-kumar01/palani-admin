...
export default function AnnadhanamPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        toast.success(editingAnnadhanam ? 'Annadhanam updated successfully!' : 'Annadhanam created successfully!', {
          position: "top-right",
          autoClose: 3000,
          hideProgressBar: false,
          closeOnClick: true,
  ...
  const confirmDeleteAnnadhanam = async () => {
    ...
    try {
      ...
      if (response.ok) {
        toast.success('Annadhanam deleted successfully!', {
          position: "top-right",
          autoClose: 3000,
          hideProgressBar: false,
          closeOnClick: true,
        ...
        toast.error(data.error || 'Failed to delete annadhanam!', {
          position: "top-right",
          autoClose: 4000,
          hideProgressBar: false,
          closeOnClick: true,
